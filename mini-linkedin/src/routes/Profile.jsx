        ...
        (profile) => {
          if (profile) {
            setPerfil({
              ...
              tipoDeficiencia: profile.tipoDeficiencia || '',
              deficiencia: profile.deficiencia || '',
              fotoURL: profile.fotoURL || '',
              tipoUsuario: profile.tipoUsuario || 'pcd',
              cpf: profile.cpf || '',
              cnpj: profile.cnpj || '',
            ...
            {perfil.tipoUsuario === 'pcd' ? (
              <>
                ...
                <select name="deficiencia" value={perfil.deficiencia} onChange={handleChange} style={{ padding: '0.75rem', borderRadius: '9999px', border: '1px solid #D9D9D9' }} disabled={uploading || !perfil.tipoDeficiencia}>
                  ...
                  {perfil.tipoDeficiencia && opcoesDeficiencia[perfil.tipoDeficiencia].map((opc) => <option key={opc} value={opc}>{opc}</option>)}
                </select>
              </>
            ) : (
              <>
